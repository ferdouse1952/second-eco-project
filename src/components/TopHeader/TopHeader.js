      ...
      <section className="head  text-white">
        <div className="d-flex justify-content-between">
          ...
          <div className="social-row d-flex">
            <i class="text-white fa-brands fa-github"></i>
            <label className="ps-2">GitHub</label>
            <i class="text-white fa-brands fa-facebook ps-4"></i>
            <label className="ps-2">Facebook</label>
            <i class="text-white fa-brands fa-instagram ps-4"></i>
            <label className="ps-2">Instagram</label>
            <i class="text-white fa-brands fa-linkedin ps-4"></i>
